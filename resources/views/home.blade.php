    ...
    <div class="bg-white dark:bg-gray-800 flex relative z-20 items-center overflow-hidden">
        <div class="container mx-auto px-6 flex relative py-16">
            ...
            <div class="hidden sm:block sm:w-1/3 lg:w-3/5 relative">
                <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60" class="max-w-xs md:max-w-sm m-auto"/>
            </div>
        </div>
    </div>
{{-- INfo Part END --}}
...
<div class="w-full bg-grey p-12 mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12">
            ...
            <div class="overflow-hidden shadow-lg rounded-lg h-90 w-60 md:w-80 cursor-pointer m-auto">
                <a href="{{  route('apartments.show',$apartment) }}" class="w-full block h-full">
                    <img alt="blog photo" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60" class="max-h-40 w-full object-cover"/>
